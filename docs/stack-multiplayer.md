...
> Documento de decisão. A stack de referência vem de uma app de conteúdo/IA
> (React/Expo + WordPress). Aqui separamos o que **aproveita** para um
...
## 2. Aproveita vs. descarta da stack de referência

| Aproveita (serve para o jogo) | Descarta (era específico da app de conteúdo/CMS) |
|---|---|
